...
local Module = {
	...
	IdleAnimationID = 6690358779; -- Change these to your animation Id
		IdleAnimationSpeed = 0.2;
	FireAnimationID = 6690367441; -- Change these to your animation Id
		FireAnimationSpeed = 5;
	ReloadAnimationID = 6690369466; -- Change these to your animation Id
